...
static
__device__ __inline__ float intersectPlane(const float3& origin,
...
static
__device__ __inline__ void refine_and_offset_hitpoint(const float3& original_hit_point, const float3& direction,
