...
public:
    ...
    void activate() {
        ...
        perspective.setRow(0, Vector4f(cot, 0, 0, 0));
        perspective.setRow(1, Vector4f(0, cot, 0, 0));
        perspective.setRow(2, Vector4f(0, 0, m_farClip * recip,
                                       -m_nearClip * m_farClip * recip));
        perspective.setRow(3, Vector4f(0, 0, 1, 0));
         ...
         */
        Matrix4f scale =
            Matrix4f::getScaleMatrix(Vector3f(-0.5f, -0.5f * aspect, 1.0f));
        Matrix4f trans = Matrix4f::getTranslationMatrix(
            Vector3f(-1.0f, -1.0f / aspect, 0.0f));
        m_sampleToCamera = Transform((scale * trans * perspective).inv());
    ...
    std::string toString() const {
        return tfm::format("PerspectiveCamera[\n"
                           ...
                           m_outputSize.toString(), m_fov, m_nearClip,
